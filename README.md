# PAYKX
  ...
  **Pre-execution verification and safety layer for high-friction and agentic payments.**
  ...
  PAYKX is a **pre-transaction decision layer** that sits before money moves. It assesses risk and intent upfront and provides a clear signal on whether a payment is safe to execute, should be delayed, or requires further review.
